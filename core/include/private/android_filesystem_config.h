...
static const struct fs_path_config android_files[] = {
    ...
    { 00755, AID_ROOT,    AID_SHELL,     CAP_MASK_LONG(CAP_NET_BIND_SERVICE),
    ...
    /* Oreo builds */ 
    { 00755, AID_SYSTEM,    AID_RADIO,     CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "system/vendor/bin/ims_rtp_daemon" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "system/vendor/bin/imsdatadaemon" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "system/vendor/bin/pm-service" },
    { 00755, AID_GPS,       AID_GPS,       CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "system/vendor/bin/slim_daemon" },
    { 00755, AID_BLUETOOTH, AID_BLUETOOTH, CAP_MASK_LONG(CAP_BLOCK_SUSPEND), "system/vendor/bin/wcnss_filter" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_ADMIN) |
                                           CAP_MASK_LONG(CAP_BLOCK_SUSPEND), 
                                               "system/vendor/bin/hw/android.hardware.bluetooth@1.0-service-qti" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_ADMIN) |
                                           CAP_MASK_LONG(CAP_BLOCK_SUSPEND), 
                                               "vendor/bin/hw/android.hardware.bluetooth@1.0-service-qti" },
    { 00755, AID_SYSTEM,    AID_RADIO,     CAP_MASK_LONG(CAP_WAKE_ALARM), "system/vendor/bin/imsrcsd" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "system/vendor/bin/pd-mapper" },
    { 00755, AID_SYSTEM,    AID_RADIO,     CAP_MASK_LONG(CAP_WAKE_ALARM), "vendor/bin/imsrcsd" },
    { 00755, AID_SYSTEM,    AID_SYSTEM,    CAP_MASK_LONG(CAP_NET_BIND_SERVICE), "vendor/bin/pd-mapper" },
